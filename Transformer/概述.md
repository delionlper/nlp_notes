...
### Add & Normalization
![](https://latex.codecogs.com/svg.latex?output=LayerNorm(x+Layer(x)))
![](https://latex.codecogs.com/svg.latex?LayerNorm(x)=\alpha\times\frac{x-\mu}{\sqrt{\sigma^2+\epsilon}}+\beta)
[为什么要用Layer Normal]()
